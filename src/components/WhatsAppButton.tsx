...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 bg-plum hover:bg-plum-light text-warm-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all group"
